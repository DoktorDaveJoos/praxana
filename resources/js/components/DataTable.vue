...
<template>
    <div v-bind="$attrs" role="group" class="space-y-4">
        ...
        <div class="flex items-center justify-end space-x-2 py-4">
            <Button variant="outline" size="sm" :disabled="!table.getCanPreviousPage()" @click="table.previousPage()"> Vorherige </Button>
            <Button variant="outline" size="sm" :disabled="!table.getCanNextPage()" @click="table.nextPage()"> Nächste </Button>
        </div>
    </div>
</template>
